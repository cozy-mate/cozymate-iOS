...
export const lifestyleOptions: Record<string, LifestyleOption> = {
  ...
  admissionYear: {
    blue: <BlueAdmissionYear />,
    white: <WhiteAdmissionYear />,
    red: <RedAdmissionYear />,
    label: '학번',
  },
  numOfRoommate: {
    blue: <BlueAdmissionYear />,
  ...
  wakeUpTime: {
    blue: <BlueWakeUpTime />,
    white: <WhiteWakeUpTime />,
    red: <RedWakeUpTime />,
    label: '기상시간',
  },
  sleepingTime: {
    blue: <BlueSleepingTime />,
    white: <WhiteSleepingTime />,
    red: <RedSleepingTime />,
    label: '취침시간',
  },
  turnOffTime: {
    blue: <BlueTurnOffTime />,
    white: <WhiteTurnOffTime />,
    red: <RedTurnOffTime />,
    label: '소등시간',
  },
  smoking: {
  ...
  heatingIntensity: {
    blue: <BlueHeatingIntensity />,
    white: <WhiteHeatingIntensity />,
    red: <RedHeatingIntensity />,
    label: '히터',
  },
  lifePattern: {
    blue: <BlueLifePattern />,
    white: <WhiteLifePattern />,
    red: <RedLifePattern />,
    label: '생활패턴',
  },
  intimacy: {
  ...
  noiseSensitivity: {
    blue: <BlueNoiseSensitivity />,
    white: <WhiteNoiseSensitivity />,
    red: <RedNoiseSensitivity />,
    label: '소음예민도',
  },
  cleaningFrequency: {
    blue: <BlueCleaningFrequency />,
    white: <WhiteCleaningFrequency />,
    red: <RedCleaningFrequency />,
    label: '청소빈도',
  },
  drinkingFrequency: {
    blue: <BlueDrink />,
...
export const getLifeStyleLabel = (key: string) => {
...
export const getLifeStyleValue = (key: string, value: string | number | string[]) => {
  ...
  switch (key) {
    ...
    case 'turnOffTime': {
      ...
      formattedValue = `${period} ${String(formattedTime).padStart(2, '0')}시`;
      break;
    }
