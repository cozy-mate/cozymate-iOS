    ...
    <View className="px-[20px] gap-y-[12px]">
      ...
      <View className="p-4 rounded-xl border border-strokeColor">
        <View className="flex flex-row items-center gap-x-[12px]">
          ...
          <Text className="text-14 font-500 leading-14 text-basicFont">{data.dormitoryName}</Text>
        </View>
        ...
        <View className="flex flex-row items-center gap-x-[12px]">
          ...
          <Text className="text-14 font-500 text-basicFont">{data.maxMateNum}인실</Text>
        </View>
      </View>
    </View>
  );
