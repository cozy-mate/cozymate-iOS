  ...
  return (
    <View className="flex flex-col items-center gap-y-[32px]">
      <View className="relative h-[120px] w-[120px] overflow-hidden rounded-[60px]">
        ...
        <Pressable
          onPress={() => router.push('/myPage/updateInfo/persona')}
        ...
        >
          <Text className="Semibold12 text-white text-center">수정</Text>
        </Pressable>
      </View>
      ...
      <View className="border border-[#F1F2F4] rounded-xl p-[16px] w-full">
        ...
        >
          <View className="flex flex-row gap-x-[8px] items-center">
            <Text className="Medium14 text-disabledFont ml-1">닉네임</Text>
            <Text className="Medium14 text-emphasizedFont">{data.result.nickname}</Text>
          </View>
          <GrayArrow />
        </Pressable>
        ...
        >
          <View className="flex flex-row gap-x-[8px] items-center">
            <Text className="Medium14 text-disabledFont ml-1">생년월일</Text>
            <Text className="Medium14 text-emphasizedFont">{formatDate(data.result.birthday)}</Text>
          </View>
          <GrayArrow />
        </Pressable>
      </View>
