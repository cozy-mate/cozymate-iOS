    ...
    <View className="pt-[12px]">
      <View className="flex flex-row justify-between items-center mb-[12px]">
        <View className="flex flex-row items-center gap-x-[8px]">
          ...
          <Text className="Medium14 text-emphasizedFont">{data.nickname}</Text>
        </View>

        <Text className="Medium12 text-disabledFont">{data.status}</Text>
      </View>

      <Text className="Medium14 text-emphasizedFont mb-[24px]">{data.content}</Text>

      <Text className="Medium12 text-disabledFont self-end">{data.datetime}</Text>
    </View>
  );
};
