...
const PostListHeader = memo(
  ({ post }: { post: Post & { commentCount: number } }) => {
  ...
  (prevProps, nextProps) => {
    return (
      prevProps.post.persona === nextProps.post.persona &&
      prevProps.post.nickname === nextProps.post.nickname &&
...
export const PostDetailCard = ({ post }: { post: Post & { commentCount: number } }) => {
